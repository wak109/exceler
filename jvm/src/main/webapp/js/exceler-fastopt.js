...
/** @constructor */
function $c_Lexceler_js_ExcelerJS$() {
  $c_O.call(this)
}
$c_Lexceler_js_ExcelerJS$.prototype = new $h_O();
$c_Lexceler_js_ExcelerJS$.prototype.constructor = $c_Lexceler_js_ExcelerJS$;
/** @constructor */
function $h_Lexceler_js_ExcelerJS$() {
  /*<skip>*/
}
$h_Lexceler_js_ExcelerJS$.prototype = $c_Lexceler_js_ExcelerJS$.prototype;
$c_Lexceler_js_ExcelerJS$.prototype.init___ = (function() {
  return this
});
$c_Lexceler_js_ExcelerJS$.prototype.main__V = (function() {
  this.appendPar__Lorg_scalajs_dom_raw_Node__T__V($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body, "Changed");
  var this$3 = $m_Lorg_scalajs_dom_ext_Ajax$();
  var headers = $m_sci_Map$EmptyMap$();
  var this$4 = this$3.apply__T__T__Lorg_scalajs_dom_ext_Ajax$InputData__I__sci_Map__Z__T__s_concurrent_Future("GET", "http://127.0.0.1:8080/api", null, 0, headers, false, "");
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(xhr$2) {
      $m_Lexceler_js_ExcelerJS$().appendPar__Lorg_scalajs_dom_raw_Node__T__V($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body, $as_T(xhr$2.responseText))
    })
  })(this));
  var executor = $m_sjs_concurrent_JSExecutionContext$Implicits$().runNow$1;
  $f_s_concurrent_Future__foreach__F1__s_concurrent_ExecutionContext__V(this$4, f, executor)
});
$c_Lexceler_js_ExcelerJS$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lexceler_js_ExcelerJS$.prototype.appendPar__Lorg_scalajs_dom_raw_Node__T__V = (function(targetNode, text) {
...
$c_Lexceler_js_ExcelerJS$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lexceler_js_ExcelerJS$ = new $TypeData().initClass({
  Lexceler_js_ExcelerJS$: 0
}, false, "exceler.js.ExcelerJS$", {
  Lexceler_js_ExcelerJS$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lexceler_js_ExcelerJS$.prototype.$classData = $d_Lexceler_js_ExcelerJS$;
var $n_Lexceler_js_ExcelerJS$ = (void 0);
function $m_Lexceler_js_ExcelerJS$() {
  if ((!$n_Lexceler_js_ExcelerJS$)) {
    $n_Lexceler_js_ExcelerJS$ = new $c_Lexceler_js_ExcelerJS$().init___()
  };
  return $n_Lexceler_js_ExcelerJS$
}
/** @constructor */
...
$e.exceler = ($e.exceler || {});
$e.exceler.js = ($e.exceler.js || {});
$e.exceler.js.ExcelerJS = $m_Lexceler_js_ExcelerJS$;
$m_Lexceler_js_ExcelerJS$().main__V();
}).call(this);
//# sourceMappingURL=exceler-fastopt.js.map
