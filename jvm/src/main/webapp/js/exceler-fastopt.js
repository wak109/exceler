...
/** @constructor */
function $c_LExcelerJS$() {
  $c_O.call(this)
}
$c_LExcelerJS$.prototype = new $h_O();
$c_LExcelerJS$.prototype.constructor = $c_LExcelerJS$;
/** @constructor */
function $h_LExcelerJS$() {
  /*<skip>*/
}
$h_LExcelerJS$.prototype = $c_LExcelerJS$.prototype;
$c_LExcelerJS$.prototype.init___ = (function() {
  return this
});
$c_LExcelerJS$.prototype.ExcelerJS$$$anonfun$main$2__Lorg_scalajs_dom_raw_Element__Lorg_scalajs_jquery_JQuery = (function(elem) {
  var jsx$1 = (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("#main");
  var s = (("<li><p>" + $as_T(elem.getAttribute("name"))) + "</p></li>");
  return jsx$1.append(s)
});
$c_LExcelerJS$.prototype.main__AT__V = (function(args) {
  var json = {
    "url": "http://127.0.0.1:8080/api",
    "type": "GET"
  };
  var promise = $m_Lorg_scalajs_jquery_package$().jQuery$1.ajax(json);
  promise.done((function($this) {
    return (function(data$2, textStatus$2, xhr$2) {
      $as_T(data$2);
      $as_T(textStatus$2);
      var xmlDoc = $m_Lorg_scalajs_jquery_package$().jQuery$1.parseXML($as_T(xhr$2.responseText));
      (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)(xmlDoc).find("book").each((function() {
        return $m_LExcelerJS$().ExcelerJS$$$anonfun$main$2__Lorg_scalajs_dom_raw_Element__Lorg_scalajs_jquery_JQuery(this)
      }))
    })
  })(this))
});
var $d_LExcelerJS$ = new $TypeData().initClass({
  LExcelerJS$: 0
}, false, "ExcelerJS$", {
  LExcelerJS$: 1,
  O: 1
});
$c_LExcelerJS$.prototype.$classData = $d_LExcelerJS$;
var $n_LExcelerJS$ = (void 0);
function $m_LExcelerJS$() {
  if ((!$n_LExcelerJS$)) {
    $n_LExcelerJS$ = new $c_LExcelerJS$().init___()
  };
  return $n_LExcelerJS$
}
/** @constructor */
...
$m_LExcelerJS$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
